...
public class CreateTest implements UseCase {
    ...
    private static final String INSURANCE_POLICY_NAME = "my-policy";
    private static final String INSURANCE_POLICY_STATUS = "ACTIVE";
    private static final String INSURANCE_POLICY_START_DATE = "2024-11-24T14:41:52.123456Z";
    private static final String INSURANCE_POLICY_END_DATE = "2025-11-24T14:41:52.123456Z";

    private static final String CREATE_COMMAND_TEMPLATE = """
            {
                "name": "${name}",
                "status": "${status}",
                "startDate": "${startDate}",
